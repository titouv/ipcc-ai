...
function ChatInput(props: { handleSubmit: (input: string) => void }) {
  const [input, setInput] = useState<string>("");

  return (
    <div className=" rounded-full  px-2 py-2  mb-8 bg-[#f4f4f4] border-none font-normal focus:outline-none  flex items-center gap-2 w-full">
      <input
...
export default function ChatPage() {
  const [conversation, setConversation] = useState<Message[]>(demoMessages);
